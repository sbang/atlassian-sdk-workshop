...
Tingene vi skal gjøre:
 1. [[#install-sdk][Få alle opp og kjøre med utviklingsomgivelsen]]
 2. [[#start-jira][Starte en Jira fra SDKen]], [[#create-jira-issue][lage et prosjekt og en sak i Jiraen]]
 3. [[#create-confluence-plugin][Lage en Confluenceplugin]]
 4. [[#import-plugin-as-ide-project][Importere Confluence-plugin'en som et Eclipse-prosjekt]]
 5. [[#start-confluence-on-plugin][starte en Confluence med plugin'en i]] (startes med mvn)
 6. [[#create-confluence-macro][Lage en makro i plugin'en]]
 7. [[#add-macro-config-parameter][Legge på en parameter i makroen]] (en konfig-parameter man kan justere i side-editoren)
 8. [[#debug-live-plugin][Demonstrere debugging in i makroen]] (vi kan debugge koden mens den kjører inne i Confluence)
 9. [[#macro-error-reporting][Implementere feilrapportering i makroen]]
 10. [[#connect-to-jira-and-fetch-data][Koble makroen mot Jira og hente data som vises fram]]
...
** Lag en confluence-plugin
   :PROPERTIES:
   :CUSTOM_ID: create-confluence-plugin
   :END:
 - Start cmd.exe
...
** Sett opp IDEen på plugin'en
   :PROPERTIES:
   :CUSTOM_ID: import-plugin-as-ide-project
   :END:
...
** Starte med atlas-debug
   :PROPERTIES:
   :CUSTOM_ID: start-confluence-on-plugin
   :END:
...
** Lag en makro i plugin'en
   :PROPERTIES:
   :CUSTOM_ID: create-confluence-macro
   :END:
*** I eclipse
...
** Legg på "issue key" som en parameter til makroen
   :PROPERTIES:
   :CUSTOM_ID: add-macro-config-parameter
   :END:
...
** Rapportere feil fra makroen
   :PROPERTIES:
   :CUSTOM_ID: macro-error-reporting
   :END:
...
** Koble makroen mot Jira
   :PROPERTIES:
   :CUSTOM_ID: connect-to-jira-and-fetch-data
   :END:
